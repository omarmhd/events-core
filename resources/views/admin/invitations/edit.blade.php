...
@section('content')
    <div class="mb-4">
        <h3 class="fw-bold text-dark mb-1">Edit Invitation</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 small">
                ...
                <li class="breadcrumb-item active text-primary">Edit Invitation</li>
            </ol>
        </nav>
    </div>
    ...
    <div class="custom-card">
        <div class="card-body p-4 p-md-5">
            ...
            <form action="{{ route('invitations.update',$row->id) }}" method="POST">
                @method("put")
                @csrf
                <div class="row g-4">
                    <div class="col-md-6">
                        ...
                        <div class="input-group-custom @error('invitee_name') has-error @enderror">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('invitee_name',$row->invitee_name) }}">
                        </div>
                        @error('invitee_name')
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group-custom @error('invitee_email') has-error @enderror">
                            ...
                            <input type="email"
                                   ...
                                   value="{{ old('invitee_email',$row->invitee_email) }}">
                        </div>
                        @error('invitee_email')
                        <div class="error-bubble">
                            <i class="fas fa-exclamation-circle"></i> <span>{{ $message }}</span>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="input-group-custom @error('invitee_position') has-error @enderror">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('invitee_position',$row->invitee_position) }}">
                        </div>
